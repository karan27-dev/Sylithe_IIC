...
// Used both as dots on the olive sidebar and as bar fills on the white chart
// cards. Picked to clear 3:1 on white — the paler tints that suit the dark
// panel drop to about 1.2:1 there, leaving the bars almost invisible.
const SOURCE_COLOR = {
  gedi_l4b: '#16a34a',
  esa_cci: '#0284c7',
