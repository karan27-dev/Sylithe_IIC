  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F0EEE6] p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-[24px] font-bold text-[#191919]">Above Ground Biomass (AGB)</h1>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-gray-200 text-center">
          ...
          <p className="text-3xl font-bold text-[#191919]">245 <span className="text-lg text-gray-500">t/ha</span></p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-gray-200 text-center">
          <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">Total Estimated Carbon</p>
          <p className="text-3xl font-bold text-[#191919]">1.2M <span className="text-lg text-gray-500">tCO₂e</span></p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-gray-200 text-center">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
        <div className="px-6 py-4 border-b border-gray-100"><h3 className="font-bold text-[#191919]">Biomass Density Map</h3></div>
