...
export default function DynamicBaselinePage() {
  return (
    <div className="flex-1 overflow-y-auto bg-[#F0EEE6] p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-[24px] font-bold text-[#191919]">Dynamic Baseline</h1>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm mb-8">
        <div className="px-6 py-4 border-b border-gray-100"><h3 className="font-bold text-[#191919]">Cumulative Deforestation (%)</h3></div>
        <div className="p-6 h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={mockBaselineData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#E3DFD3" />
              <XAxis dataKey="year" tick={{ fontSize: 12, fill: '#6C6B68' }} />
              <YAxis domain={['auto', 'auto']} tick={{ fontSize: 12, fill: '#6C6B68' }} />
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-gray-200">
          <h3 className="font-bold text-[#191919] mb-4">Matching Covariates</h3>
        ...
        <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100 flex flex-col justify-center items-center text-center">
          ...
          <p className="text-4xl font-black text-[#191919]">19.7%</p>
