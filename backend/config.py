...
JWT_EXPIRY_DAYS = 7
# Default platform admins (always granted), plus any set via the ADMIN_EMAILS env var.
_DEFAULT_ADMIN_EMAILS = {"karan270905@gmail.com", "chhelurathore773@gmail.com"}
ADMIN_EMAILS = _DEFAULT_ADMIN_EMAILS | set(
    e.strip().lower()
